...
author_name = 'Continuous Example - Single product attribute WTP.'
nsamples = 5000
answers = [0, 1]
...
# Continuous example. Price difference ranges between -5 and 5 dollars.
designs=None
design_bounds = np.array([
    [-5, 5] # Price difference between -$5 and $5
])
